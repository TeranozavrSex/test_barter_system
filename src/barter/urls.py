...
urlpatterns = [
    ...
    path(
        "proposals/create/<int:ad_id>/", views.create_proposal, name="create_proposal"
    ),
    path(
        "proposals/<int:proposal_id>/<str:status>/",
    ...
    path(
        "api/proposals/<int:pk>/", views.proposal_detail_api, name="api_proposal_detail"
    ),
    path(
        "api/proposals/create/<int:ad_id>/",
        views.proposal_create_api,
        name="api_proposal_create",
    ),
    path(
        "api/proposals/<int:pk>/update/",
        views.proposal_update_api,
        name="api_proposal_update",
    ),
]
